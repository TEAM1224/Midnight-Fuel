...
export const fetchProduct = createAsyncThunk('/get-product',
    async()=>{
        const response = await axios.get(`${apiUrl}/api/seller/get-products`,
...
export const addProduct = createAsyncThunk('/add',
    async(formData)=>{
        const response = await axios.post(`${apiUrl}/api/seller/add`, formData,
        {withCredentials: true})
...
export const editProduct = createAsyncThunk('/edit-product',
    async({formData, productId})=>{
        const response = await axios.put(`${apiUrl}/api/seller/${productId}`, formData,
        {withCredentials: true})
...
export const updateProduct = createAsyncThunk('/update-product',
    async({productId, price, quantity})=>{
        const response = await axios.put(`${apiUrl}/api/seller/edit/${productId}`,{price, quantity})
...
export const deleteProduct = createAsyncThunk('/delete-product',
    async(productId)=>{
        const response = await axios.delete(`${apiUrl}/api/seller/delete/${productId}`)
        return response?.data;
    }
)
...
export const fetchOrders = createAsyncThunk('/fectch All orders',
    async()=>{
        const response = await axios.get(`${apiUrl}/api/seller/get-orders`,
        {withCredentials: true})
        return response?.data;
    }
)
