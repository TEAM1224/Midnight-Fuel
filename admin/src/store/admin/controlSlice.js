...
export const getUser = createAsyncThunk('/getUser', 
    async()=>{
        const response = await axios.post(`${apiUrl}/api/admin/get-users`,
            {},
            {headers : {
...
export const getSeller = createAsyncThunk('/getseller',
    async()=>{
        const response = await axios.post(`${apiUrl}/api/admin/get-sellers`,{},
            {headers : {
                adminToken : localStorage.getItem('adminToken'),
            }},
        )
...
export const verifySeller = createAsyncThunk('/verifySeler',
    async(sellerId)=>{
        try {
            const response = await axios.post(`${apiUrl}/api/admin/verify-seller/${sellerId}`,
                {},
                {headers : {
                    adminToken : localStorage.getItem('adminToken'),
                }},
...
export const rejectSeller = createAsyncThunk('/rejectSeller',
    async(sellerId)=>{
        ...
        try {
            const response = await axios.post(`${apiUrl}/api/admin/reject-seller/${sellerId}`,
                {},
                {headers : {
                    adminToken : localStorage.getItem('adminToken'),
                }},
